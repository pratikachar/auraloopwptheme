...
<meta name="google-site-verification" content="88a9a1035955ca88" />
<script async src="https://www.googletagmanager.com/gtag/js?id=G-JJG011EYXE"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-JJG011EYXE');
</script>
<script type="text/javascript">
    ...
    })(window, document, "clarity", "script", "x7uibuzlln");
</script>
<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
